...
echo "starting NXP generation script into $LF_SOURCE_GEN_DIRECTORY"
echo "pwd is $(pwd)"

# Copy platform into /core
cp $PROJECT_ROOT/platform/lf_nxp_support.c $LF_SOURCE_GEN_DIRECTORY/core/platform/
cp $PROJECT_ROOT/platform/lf_nxp_support.h $LF_SOURCE_GEN_DIRECTORY/core/platform/
...
cp $PROJECT_ROOT/platform/lf_nxp_support.c $LF_SOURCE_GEN_DIRECTORY/include/core/platform/
cp $PROJECT_ROOT/platform/lf_nxp_support.h $LF_SOURCE_GEN_DIRECTORY/include/core/platform/
